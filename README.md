...
- **DateToString**(t time.Time, patterns ...string) (string, error)

  The DateToString converts a Date to a string based on the provided format. Supports both Golang and Python style formatting. If multiple formats are provided, only the first one will be processed.

- **DateToStrings**(t time.Time, patterns ...string) ([]string, error)

  The DateToStrings converts a Date to a string based on the provided format. Supports both Golang and Python style formatting.
